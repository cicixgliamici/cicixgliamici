...
I'm currently pursuing a Master's degree in Computer Engineering (**LM-32**) at the **University of Bologna**.  
At the same time, I am working at the **European Defence Agency** as a **Trainee in Project Management and Information Technology**.  
...
Here’s an overview of the main types of repositories you’ll find on my GitHub profile.

### Personal Projects
Projects developed independently to explore ideas, technologies, and personal interests.
...
- [Main technologies, tools, or skills used]
- [Optional achievement or contribution]
...
---
## Formal Education 🎓
📄 [Full academic coursework](./education.md)
...
| 1st Year | 2nd Year |
|----------|----------|
| Operating Systems | Foundations of Logic for Computer Science |
| Real-Time Systems | Cybersecurity |
...
|----------|----------|----------|
| Geometry and Linear Algebra | Logic and Algebra | Database Systems |
| Calculus I | Calculus II | Software Engineering |
| Physics | Computer Architecture and Operating Systems | Information Systems |
| Fundamentals of Computer Science | Algorithms and Foundations of Computer Science | Digital Logic Design |
| Fundamentals of Communications and Internet Technologies | Probability and Statistics for Computer Science | Robotics |
| Electrical Engineering Fundamentals | Measurement and Instrumentation | Fundamentals of Electronics |
|  | Control Systems Fundamentals | Bioinformatics Algorithms |


### High School Diploma  
**Liceo Classico G. C. Tacito, Terni**

- Classical studies background with a strong focus on humanities, literature, and philosophy
